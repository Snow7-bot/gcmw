...
- 扫描 HEAD：`80e2ffa7ac2da7146851b1c27204277f73817378`（最新 main）
- 配置版本：`.gitleaks.toml`（#22 合并后；扫描时 main 含 #24 合并）
- 配置参数：默认规则 + `.gitleaks.toml` 二进制/媒体排除
- 扫描范围：完整 Git 历史
- 扫描提交数：43
- 扫描字节：约 39 MB
...
- 195 个独立候选需由真实凭据负责人在内部区分真实凭据与误报；本报告不公开具体值。
